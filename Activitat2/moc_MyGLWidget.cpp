...
QT_MOC_LITERAL(1, 11, 7), // "nArbres"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8), // "setTrees"
QT_MOC_LITERAL(4, 29, 8) // "numTrees"

    },
    "MyGLWidget\0nArbres\0\0setTrees\0numTrees"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->nArbres((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setTrees((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::nArbres)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::nArbres(int _t1)
{
